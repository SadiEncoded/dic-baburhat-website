...
const Topbar: React.FC = () => {
  return (
    <div style={{ backgroundColor: theme.colors.primary, color: theme.colors.neutralWhite }} className="text-sm">
      <Container className="py-2 flex justify-between items-center">
        <div className="flex items-center gap-4">
          <span className="hidden sm:inline">📞 +880 1713 493227</span>
          <a href="mailto:info@dic.edu.bd" className="underline hover:text-primaryLight transition">
            info@dic.edu.bd
          </a>
        </div>
        <div className="flex items-center gap-4">
          <a
            ...
            style={{ backgroundColor: theme.colors.neutralWhite, color: theme.colors.primary }}
          >
            Student Login
          </a>
          <a
  ...
  return (
    ...
    >
      <Container className="py-4 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-6 text-sm" style={{ color: theme.colors.neutralText }}>
          {navItems.map((item, idx) => (
            <div key={idx} className="relative group">
              <a
                href={item.href || '#'}
                className={`px-3 py-2 rounded-xl font-medium transition-all duration-200 hover:scale-105 ${
                  activeSection === item.href?.substring(1) ? 'text-blue-700 font-semibold' : 'text-neutral-700'
                }`}
                style={{
                  backgroundColor: theme.colors.neutralWhite,
                  boxShadow: theme.shadows.neumorphic,
...
const Hero: React.FC<{ id: string }> = ({ id }) => {
  ...
  const slides = [
    ...
    { src: "/Hero Corusel/chairmanvisit.jpg", alt: "Chairman visit at Daffodil International College", caption: "Leadership Engagement" },
    { src: "/Hero Corusel/chairmanvisit1.jpg", alt: "Another chairman visit at Daffodil International College", caption: "Guiding Our Future" },
    { src: "/Hero Corusel/CSE2ndbatch.jpg", alt: "CSE 2nd batch at Daffodil International College", caption: "Pioneering Tech Talent" },
    { src: "/Hero Corusel/CSEAllSemester.jpg", alt: "All semesters of CSE at Daffodil International College", caption: "Comprehensive Learning" },
    { src: "/Hero Corusel/HSC25.jpg", alt: "HSC 2025 event at Daffodil International College", caption: "Excelling in HSC 2025" },
    { src: "/Hero Corusel/Principle.jpg", alt: "Principal at Daffodil International College", caption: "Leadership in Action" },
    { src: "/Hero Corusel/StudentsAchivments.jpg", alt: "Student achievements at Daffodil International College", caption: "Recognizing Excellence" },
    { src: "/Hero Corusel/StudentsAchivments1.jpg", alt: "More student achievements at Daffodil International College", caption: "Achievements Unleashed" },
    { src: "/Hero Corusel/StudentsAchivments3.jpg", alt: "Further student achievements at Daffodil International College", caption: "Success Stories" },
    { src: "/Hero Corusel/VibrantStudents1.jpg", alt: "Vibrant students at Daffodil International College", caption: "Energetic Campus Life" },
  ];
    ...
    <section id={id} style={{ backgroundColor: theme.colors.neutralWhite }}>
      <Container className="py-16 lg:py-24">
        <div className="relative">
          ...
          <div className="overflow-hidden rounded-2xl" style={{ boxShadow: theme.shadows.card }}>
              ...
              <div className="mt-4 flex gap-4">
                <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 300, damping: 10 }}>
                  <Link
                    ...
                    style={{ backgroundColor: theme.colors.primary, color: theme.colors.neutralWhite }}
                  >
                    Apply Now
                  </Link>
                </motion.div>
                <motion.div whileHover={{ scale: 1.05 }} transition={{ type: "spring", stiffness: 300, damping: 10 }}>
                  <Link
                    ...
                    style={{ borderColor: theme.colors.neutralGray, color: theme.colors.neutralText }}
                  >
                    View Gallery
                  </Link>
                </motion.div>
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-4">
            {slides.map((_, index) => (
              ...
              >
                <Dot size={16} className={currentSlide === index ? 'text-white' : 'text-white/40'} />
              </motion.button>
            ))}
          </div>
        ...
        {/* Text Content */}
        <div className="mt-10">
          <p className="text-xs uppercase tracking-wide font-semibold" style={{ color: theme.colors.primaryDark }}>
            Daffodil International College — Baburhat
          </p>
          <p className="mt-4 text-base max-w-xl" style={{ color: theme.colors.neutralText }}>
            We combine rigorous academics with hands-on experience to prepare students for professional success. Accredited programs, industry-aligned curricula, and a vibrant campus life.
          </p>
          ...
          <div className="mt-8 grid grid-cols-3 gap-4">
            {[
              ...
              <div
                ...
                style={{ backgroundColor: theme.colors.primaryLight, boxShadow: theme.shadows.card }}
              >
                <div className="text-2xl mb-2">{stat.icon}</div>
                <div className="text-xl font-bold" style={{ color: theme.colors.neutralText }}>
                  {stat.value}
                </div>
                <div style={{ color: theme.colors.neutralSoft }}>{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
  ...
  return (
    <section id={id} style={{ backgroundColor: theme.colors.neutralGray }} className="py-12">
      <Container className="grid lg:grid-cols-2 gap-8 items-center">
        <div>
          <h2 style={{ color: theme.colors.neutralText }} className="text-2xl font-semibold">
            Why Choose DIC — Baburhat
          </h2>
          <p style={{ color: theme.colors.neutralSoft }} className="mt-4 max-w-lg">
            We focus on quality education, measurable outcomes, and industry connectivity to ensure graduates are job-ready and confident.
          </p>
          <ul className="mt-6 space-y-3 list-disc list-inside" style={{ color: theme.colors.neutralText }}>
            {bullets.map((b, i) => (
              <li key={i}>{b}</li>
            ))}
          </ul>
        ...
        <div>
          <div className="aspect-video rounded-2xl overflow-hidden" style={{ boxShadow: theme.shadows.card }}>
            <Image
...
const News: React.FC<{ id: string }> = ({ id }) => {
  ...
  return (
    <section id={id} style={{ backgroundColor: theme.colors.neutralWhite }} className="py-12 border-t">
      <Container>
        <h3 style={{ color: theme.colors.neutralText }} className="text-xl font-semibold">
          Latest News & Notices
        </h3>
        <div className="mt-6 grid md:grid-cols-3 gap-6">
          {articles.map((a, i) => (
            ...
            >
              ...
              <h4 style={{ color: theme.colors.neutralText }} className="mt-2 font-semibold">
                {a.title}
              </h4>
              <a
                href="#"
...
const Footer: React.FC = () => {
  return (
    <footer style={{ backgroundColor: theme.colors.primaryDark, color: theme.colors.neutralWhite }} className="mt-12">
      <Container className="py-10 grid md:grid-cols-3 gap-6">
        <div>
          <div className="font-bold text-lg">Daffodil International College — Baburhat</div>
          <p className="mt-3 text-sm text-white/80">
            Quality education with a focus on employability and ethical leadership.
          </p>
        </div>
        <div>
          <div className="font-semibold">Quick Links</div>
          <ul className="mt-3 space-y-2 text-sm text-white/90">
            {['About', 'Admissions', 'Academics', 'Notice Board'].map((link, i) => (
              <li key={i}>
                <a href={`#${link.toLowerCase()}`} className="hover:underline transition">
                  {link}
                </a>
              </li>
            ))}
        ...
        <div>
          ...
          <div className="mt-3 text-sm text-white/90">3/3, Block-A, Lalmatia, Dhaka — 1207</div>
          <div className="mt-2 text-sm">
            <a href="mailto:info@dic.edu.bd" className="hover:underline transition">
              info@dic.edu.bd
            </a>
          </div>
      ...
      <div className="border-t border-white/10 py-4 text-sm text-white/80">
        <Container className="flex justify-between items-center">
          <div>© {new Date().getFullYear()} Daffodil International College — Baburhat. All rights reserved.</div>
          <div className="space-x-3">
            <a href="#" className="underline hover:text-primaryLight transition">
              Privacy
            </a>
            <a href="#" className="underline hover:text-primaryLight transition">
              Terms
...
const CorporateHomepage: React.FC = () => {
  return (
    <>
      <Head>
        <title>Daffodil International College — Baburhat | Quality Education</title>
        <meta
          name="description"
          content="Daffodil International College offers industry-aligned programs and modern facilities to shape future leaders."
        />
        <meta name="keywords" content="education, college, Daffodil International, Baburhat, admissions" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className="min-h-screen" style={{ fontFamily: theme.fontFamily, backgroundColor: theme.colors.neutralWhite }}>
        <Topbar />
        <Header />
        <main>
          <Hero id="hero" />
